...
/*
v9:
Построить класс для работы с информацией о студенте. Класс должен
включать следующие поля: фамилию (динамическое выделение памяти для
фамилии), возраст, средний балл.
Класс должен обеспечивать простейшие методы для работы с полями
класса: получение значений, изменение значений, вывод значений.
*/
