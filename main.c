...
int get_user_input(char* out1, char* out2) {
    ...
    for (int i = 0; i < 2 && ch != EOF; i++) {
        ...
        //Пока получаем из stdin шестнадцатеричные цифры - пишем их в out 1 или 2, сдвигая позицию.
...
int main() {
    ...
    if (get_user_input(in1, in2)) {
        ...
        //В системе счисления от минимально возможной для введённых символов 1 числа, и до 16:
        for (int in_base1 = get_min_base(in1); in_base1 <= 16; in_base1++) {
            ...
            //В системе счисления от минимально возможной для введённых символов 2 числа, и до 16:
        ...
        if (!printed) {
            printf("Для введённых чисел не существует конверсий, приводящих к одинаковому выводу.\n");
        }
    } else {
